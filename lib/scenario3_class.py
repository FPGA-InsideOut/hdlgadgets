...
from lib.gadgets.gadget_fplate_sc3_class import gadget_fplate_sc3

class scenario3(scenariotop):
        ...
        def __init__(self):
                ...
                self._fplate = gadget_fplate_sc3()
        ...
        def setup_2d_model (self, ctx):
                ...
                self._fifo2.setup_2d_model(self._ctx.subwin(3, 51))
                self._fifotr2.setup_2d_model(self._ctx.subwin(3, 51))
