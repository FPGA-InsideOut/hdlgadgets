...
from lib.gadgets.gadget_control_join_class import gadget_control_join
from lib.gadgets.gadget_fplate_sc10_class import gadget_fplate_sc10

class scenario10(scenariotop):
        ...
        def __init__(self):
                ...
                self._control = gadget_control_join()
                self._fplate = gadget_fplate_sc10()
        ...
        def setup_2d_model (self, ctx):
                ...
                self._modelqueue.setup_2d_model(self._ctx.subwin(31, 54))
                self._check.setup_2d_model(self._ctx.subwin(31, 92))
