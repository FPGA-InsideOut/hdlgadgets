...
class gadget_custlogic_xl(gadgettop):
        ...
        def drive_2d_model (self):
                ...
                self._wctx.addstr(13,0, u'\u2502\u0020\u0064\u0065\u0062\u0075\u0067\u003A\u0020\u2502'.encode('utf-8'), curses.color_pair(1))
                ...
                self._wctx.addstr(22,0, u'\u2502\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2502'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(23,0, u'\u2502\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2502'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(24,0, u'\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518'.encode('utf-8'), curses.color_pair(1))
                ####DEBUG[0]####
                if (self.logicstate_post['debug'][0] == '1'):
                    self._wctx.addstr(14,1, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][1] == '1'):
                    self._wctx.addstr(14,2, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][2] == '1'):
                    self._wctx.addstr(14,3, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][3] == '1'):
                    self._wctx.addstr(14,4, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][4] == '1'):
                    self._wctx.addstr(14,5, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][5] == '1'):
                    self._wctx.addstr(14,6, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][6] == '1'):
                    self._wctx.addstr(14,7, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['debug'][7] == '1'):
                    self._wctx.addstr(14,8, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
