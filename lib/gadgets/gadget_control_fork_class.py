...
class gadget_control_fork(gadgettop):

        def __init__(self):
                super().__init__()

                #Logic state
                self.logicstate_pre = {'up_valid':[None], 'up_data':[None,None,None,None,None,None], 'down_ready_a':[None], 'down_ready_b':[None], 'rst':[None]}
                self.logicstate_post = {'up_valid':[None], 'up_data':[None,None,None,None,None,None], 'down_ready_a':[None], 'down_ready_b':[None], 'rst':[None]}

                #Control state
                self.controlstate_pre = {'up_valid':[None], 'up_data':[None,None,None,None,None,None], 'down_ready_a':[None], 'down_ready_b':[None], 'rst':[None]}
                self.controlstate_post = {'up_valid':['0'], 'up_data':['0','0','0','0','0','0'], 'down_ready_a':['0'], 'down_ready_b':['0'], 'rst':['0']}
        ...
        def process_input_stimulus (self, hdlpath, key):
                ...
                if (key == 115):                                                                                         #s-sym pressed
                     self.controlstate_post['down_ready_a'][0] = '0' if (self.controlstate_pre['down_ready_a'][0] == '1') else '1'
                if (key == 83):                                                                                          #S-sym pressed
                     self.controlstate_post['down_ready_b'][0] = '0' if (self.controlstate_pre['down_ready_b'][0] == '1') else '1'
                ...
                hdlpath.down_ready_a.value = Bit(helper.show_dict_charlist_as_string(self.controlstate_post['down_ready_a']))
                hdlpath.down_ready_b.value = Bit(helper.show_dict_charlist_as_string(self.controlstate_post['down_ready_b']))
        ...
        def get_logic_state_data_from_simulator (self, hdlpath):
                ...
                helper.put_hdl_vector_to_dict(self.logicstate_post['down_ready_a'], hdlpath.down_ready_a.value.binstr)
                helper.put_hdl_vector_to_dict(self.logicstate_post['down_ready_b'], hdlpath.down_ready_b.value.binstr)
        ...
        def drive_2d_model (self):
                ...
                self._wctx.addstr(4,0,  u'\u2551\u0020\u0064\u006F\u0077\u006E\u005F\u0072\u0065\u0061\u0064\u0079\u005F\u0061\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u002D\u0020\u0022\u0073\u002D\u0073\u0079\u006D\u0022\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2551'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(5,0,  u'\u2551\u0020\u0064\u006F\u0077\u006E\u005F\u0072\u0065\u0061\u0064\u0079\u005F\u0062\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u002D\u0020\u0022\u0053\u002D\u0073\u0079\u006D\u0022\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2551'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(6,0,  u'\u2551\u0020\u0043\u006C\u006F\u0063\u006B\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u002D\u0020\u0022\u0045\u004E\u0054\u0045\u0052\u002D\u006B\u0065\u0079\u0022\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2551'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(7,0,  u'\u2551\u0020\u0051\u0075\u0069\u0074\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u002D\u0020\u0022\u0045\u0053\u0043\u002D\u006B\u0065\u0079\u0022\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u0020\u2551'.encode('utf-8'), curses.color_pair(1))
                self._wctx.addstr(8,0,  u'\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D'.encode('utf-8'), curses.color_pair(1))
                ####RST####
                if (self.logicstate_post['rst'][0] == '1'):
                    self._wctx.addstr(1,16, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['up_valid'][0] == '1'):
                    self._wctx.addstr(2,16, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                ...
                if (self.logicstate_post['up_data'][5] == '1'):
                    self._wctx.addstr(3,21, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                elif (self.logicstate_post['up_data'][5] == '0'):
                    self._wctx.addstr(3,21, u'\u25CB'.encode('utf-8'), curses.color_pair(1))
                else:
                    self._wctx.addstr(3,21, u'\u00D7'.encode('utf-8'), curses.color_pair(1))
                ####DOWN_READY_A####
                if (self.logicstate_post['down_ready_a'][0] == '1'):
                    self._wctx.addstr(4,16, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                elif (self.logicstate_post['down_ready_a'][0] == '0'):
                    self._wctx.addstr(4,16, u'\u25CB'.encode('utf-8'), curses.color_pair(1))
                else:
                    self._wctx.addstr(4,16, u'\u00D7'.encode('utf-8'), curses.color_pair(1))
                ####DOWN_READY_B####
                if (self.logicstate_post['down_ready_b'][0] == '1'):
                    self._wctx.addstr(5,16, u'\u25C9'.encode('utf-8'), curses.color_pair(1))
                elif (self.logicstate_post['down_ready_b'][0] == '0'):
                    self._wctx.addstr(5,16, u'\u25CB'.encode('utf-8'), curses.color_pair(1))
                else:
                    self._wctx.addstr(5,16, u'\u00D7'.encode('utf-8'), curses.color_pair(1))
